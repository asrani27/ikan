   ...
   <div class="row">
    <div class="col-md-12">
        <div class="box box-success">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="/superadmin/pengambilan/create" method="post">
                @csrf
              <div class="box-body">
                ...
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Lokasi Pengambilan</label>
                  <div class="col-sm-10">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="jumlah" class="form-control" required onkeypress="return hanyaAngka(event)">
                  </div>
                </div>
                <div class="form-group">
