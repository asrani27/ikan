...
<body>
    <table border=0 width="100%">
        ...
        <tr>
            <td colspan=3 style="text-align:center"><br/><strong><u>LAPORAN PEMASARAN</u></strong></td>
        </tr>
    </table>
    <br/>
    <table border=1 cellspacing="0" cellpadding="3" width="100%">
        ...
        @foreach ($data as $key => $item)
            <tr>
                ...
                <td style="text-align: center">{{$item->usaha}}</td>
                <td style="text-align: center">{{$item->alamat}}</td>
                <td style="text-align: center">{{$item->ikan_id}}</td>
