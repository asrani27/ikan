    ...
    <nav class="navbar navbar-static-top"  style="box-shadow: 0 8px 8px 0 rgba(0,0,0,.2);">
      <div class="container">
        <div class="navbar-header">
          <a href="#" class="navbar-brand"><b><i>SISTEM BUDIDAYA PERIKANAN</i></b></a>
          ...
          <br/><br/>
            <div class="box box-warning">
              <div class="box-header with-border text-center">
                <img src="/logo.png" width="15%"><br/><br/>
                <h3 class="box-title">KAB. BARITO SELATAN </h3>
              ...
              <div class="box-footer social-auth-links">
                <button type="submit" class="btn btn-danger btn-flat btn-block"><i class="fa fa-sign-out"></i> Masuk</button>
              </div>
              </form>
            </div>
          </div>
